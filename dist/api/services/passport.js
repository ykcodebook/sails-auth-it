  ...
  passport.loadStrategies = function () {
    ...
    _.each(strategies, _.bind(function (strategy, key) {
      ...
      if (key === 'local') {
        ...
        var baseUrl = '';
        if (sails.config.socialRedirectURL && sails.config.socialRedirectURL !== null) {
          baseUrl = sails.config.socialRedirectURL;
        } else {
          sails.log.warn('Please add "socialRedirectURL" configuration value.');
